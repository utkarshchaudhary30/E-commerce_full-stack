    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
             ...
             <p className='text-gray-500'>212106 Bharahara,Deora Road <br /> Khiri,Kaundhiyara,Prayagraj,India</p>
             <p className='text-gray-500'>Tel:(+91)1800-643-7777 <br />Email: admin@forever.com</p>
